...
build-prerequisites: download-docker-image validate-docker-image
...
deploy-prerequisites: validate-utilities-installed generate-resource-templates start-cluster load-local-images create-namespace
